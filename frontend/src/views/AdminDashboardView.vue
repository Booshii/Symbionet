<template>
    <div id="dashboard">
        ...
        <Sidebar @selectComponent="changeComponent" /> 
...
<script setup>
    ...
    import UserCompanyEditView from '../components/organisms/UserCompanyEditView.vue';
    ...
    const currentComponent = ref(components.SdgSettingsView); // Setze die Standardkomponente auf UserInformationView
