    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SdgTypes", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactEmail = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ContactTel = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SdgTargets_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "SdgTargetSdgTypes",
                columns: table => new
                {
                    SdgTargetId = table.Column<int>(type: "int", nullable: false),
                    SdgTypeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SdgTargetSdgTypes", x => new { x.SdgTargetId, x.SdgTypeId });
                    table.ForeignKey(
                        name: "FK_SdgTargetSdgTypes_SdgTargets_SdgTargetId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SdgTargetSubGoals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SdgTargetSubGoals_SdgTargets_SdgTargetId",
                        column: x => x.SdgTargetId,
                        principalTable: "SdgTargets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SdgTargets_CompanyId",
                table: "SdgTargets",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_SdgTargetSdgTypes_SdgTypeId",
                table: "SdgTargetSdgTypes",
                column: "SdgTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_SdgTargetSubGoals_SdgTargetId",
